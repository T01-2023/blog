<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-form.input-text id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')" required autocomplete="username" />
        ...
        <div class="mt-4">
            ...
            <x-form.input-text id="password" class="block mt-1 w-full"
                            type="password"
                            name="password"
        ...
        <div class="mt-4">
            ...
            <x-form.input-text id="password_confirmation" class="block mt-1 w-full"
                            type="password"
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <x-button.button-submit class="ms-4">
                {{ __('Register') }}
